...
tag_behaviour = function(arguments,id,attrs,fn){
...
self_closing_tag_behaviour = function(args,id,attrs){
...
non_self_closing_tags.forEach(function(key) {	
	livehtml[key] = new Function(
		'return function '+key+'(id,attrs,fn){ \
			glevel = 0; deepest = 0; tag_behaviour(arguments,id,attrs,fn); \

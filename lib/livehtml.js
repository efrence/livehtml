...
non_self_closing_tags.forEach(function(key) {
	...
	eval('livehtml.'+key+' = function '+key+'(id,attrs,fn){ var glevel = 0; deepest = 0;  eval(tag_behaviour); var res = String(arguments.callee.content); if(arguments.callee.caller.fakename == undefined) {reset(null,true);} return res; };');
